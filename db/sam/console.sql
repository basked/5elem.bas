...
(
  ...
  rootId int null comment 'Главная категория товара в 5элем',
...
(
  ...
  constraint s_pars_product_5_s_pars_category_5_id_fk
  foreign key (category_id) references user1111058_sam.s_pars_category_5 (id)
)
