...
//$db= new \MySqlDB\MySqlDB();
//nsertProduct();
//var_dump(getProductDesc(433,24851));
//echo date("H:i:s");
//$tt=getCategoryDesc('https://5element.by/catalog/849-nastolnye-lampy');
//var_dump($tt['catId'].'-'.$tt['countProd']);
...
/*
for ($i=0;count($arrs);$i++)
{
    echo $arr[$i]['name'];
};
//echo getCountProduct('https://5element.by/catalog/849-nastolnye-lampy');
//echo date("H:i:s");
//testCatId();
//echo date("H:i:s");
*/